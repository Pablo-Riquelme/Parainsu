...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h2 class="card-title mb-0"><i class="fas fa-plus-circle"></i> Programar Nuevo Mantenimiento</h2>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('mantenimientos.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="equipo_ti_id" name="equipo_ti_id" required>
                        ...
                        @foreach ($equiposTi as $equipo)
                            <option value="{{ $equipo->id }}" {{ old('equipo_ti_id') == $equipo->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo" name="tipo" value="{{ old('tipo') }}" placeholder="Ej: Preventivo, Correctivo" required>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Programar Mantenimiento</button>
